...
function About() {
  return (
    <div className="about-wrapper flex-col flex h-[100%]  gap-20 [&>*]:font-ananada bg-[#100F15]">
      <div className="about-wrapper-header relative w-[100%] text-center flex justify-center">
      ...
      <div className="about-wrapper-content flex h-100 items-center justify-center gap-20">
        <div className="about-content flex gap-5 mt-auto justify-between">
        ...
        <div className="skills-wrapper mt-auto">
          <div className="tech-stack flex text-[50px] gap-20  flex-wrap">
            <div className="flex flex-col [&>*>*]:font-ananada [&>i>p]:text-2xl">
